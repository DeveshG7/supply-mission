...
var packageBody,ground, box1, box2, box3, boxBody,boxBody2
...
function setup() {
	...
	World.add(world, packageBody);
	 ...
	 boxBody = Bodies.rectangle(400, 640, 200, 20 , {isStatic:true} );
	 World.add(world, boxBody);

	 boxBody2 = Bodies.rectangle(280,625,20,100, {isStatic:true} );
...
function draw() {
  ...
  box1.x= boxBody.position.x 
  box1.y= boxBody.position.y 
